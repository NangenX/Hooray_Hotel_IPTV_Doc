...
13. <font color="red">**HD**</font>: В поле `HD` отметьте фильм как фильм высокого качества. Фильмы HD помечаются на терминале, чтобы гости могли отличать их от обычных фильмов.

14. <font color="red">**Взрослый контент**</font>: В поле `Взрослый контент` отметьте фильм как контент для взрослых. При включении терминал требует от гостя подтверждения сообщения `Предупреждение для взрослых` перед воспроизведением, а в деталях фильма отображается предупреждение о проверке возраста.

15. <font color="red">**Предупреждение для взрослых**</font>: В поле `Предупреждение для взрослых` введите сообщение подтверждения, отображаемое гостю перед воспроизведением фильма для взрослых (например, «Этот контент только для взрослых»). Это поле доступно только при включённом параметре `Взрослый контент`.

> **Примечание**: фоновый плеер предпросмотра обновлён до HTML5-плеера, поэтому предпросмотр фильмов можно воспроизводить прямо в браузере без сторонних плагинов плеера.
