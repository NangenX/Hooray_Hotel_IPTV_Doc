...
In `Weather Menu`, administrators can add, delete, and modify the names of destination cities. The IPTV system will automatically obtain the 7-day weather information of these cities through a third-party interface based on the city names, and then forward this information to terminal devices through interface messages. The terminal devices will display the information on the screen.

![Weather Setting](_images/weather/weather_2.png)

Press `Add` button to create new city weather information.
...
<font color="red">**City**</font> Select the `city` from the dropdown list. This city is the destination city for which you need to query the weather.
